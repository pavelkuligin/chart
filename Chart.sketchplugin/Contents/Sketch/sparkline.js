...
exports['default'] = function (context) {
	...
	function createSparkline(Num) {
		...
		var xStep = canvas.width[Num] / (dataObj.columns - 1);
		...
		var x0 = canvas.x[Num],
		    ...
		    minValue = 0,
		    zero = canvas.y[Num] + canvas.height[Num];
		...
		y0 = zero - canvas.height[Num] / maxValue * (Number(dataObj.table[Num][0]) + minValue);
		...
		(0, _selectionToGroup.selectionToGroup)(canvas, "Sparkline");
	}
