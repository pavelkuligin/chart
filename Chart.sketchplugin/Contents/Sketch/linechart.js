...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/linechart.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  function createLineChart() {
    ...
    for (var i = 0; i < dataObj.rows; i++) {
      y0 = zero - canvas.height / maxValue * (Number(dataObj.table[i][0]) + minValue); // Create line chart
    ...
    Object(_selectionToGroup__WEBPACK_IMPORTED_MODULE_1__["selectionToGroup"])(canvas, "Line chart");
  }
